...
def main():
    ...
    for item in data_array:
        ...
        if os.path.exists(filepath):
            ...
            highlight = []
            for suggested_outcome in sub_data["outcomes"]:
                for published_outcome in item["outcomes"]:
            ...
            if len(highlight) > 0:
                highlight_all_matches(highlight, f'outcome_htmls/{item["key"]}_outcome_text_matches.html', item["key"])
        ...
        for ea in other:
            ...
            if len(highlight) > 0:
                highlight_all_matches(highlight, f'outcome_htmls/{item["key"]}_compare_to_{ea}_for_outcome_text_matches.html', item["key"])
